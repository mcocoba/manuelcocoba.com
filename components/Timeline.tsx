  ...
  <>
    ...
    <ul>
      <Step title="Returned to Hermosillo, Mex.">
        At the end I didn't match with AhorroLibre's ideology and I decided to return to my hometown.
      </Step>
      <Step title="Joined ISEA 🧑🏽‍💻" stack={['PHP', 'Laravel']}>
        I joined to ISEA, government office as lead developer.
      </Step>
    </ul>
    <Divider />
    <Year>2015</Year>
    <ul>
      <Step title="Joined AhorroLibre Fintech Startup 🧑🏽‍💻" stack={['PHP', 'Zend Framework']}>
        I joined as backend developer to another startup.
      </Step>
      <Step title="Moved to Tijuana, Mex.">
        I moved to Tijuana for 1st time to work at AhorroLibre on-site.
      </Step>
    </ul>
    <Divider />
    <Year>2013</Year>
    <ul>
      <Step title="I joined SerpicoDev 🧑🏽‍💻" stack={['PHP', 'CodeIgniter', 'WordPress']}>
        My former mentor invite me to apply and I made it into SerpicoDev as a freelance remote PHP developer.
      </Step>
    </ul>
    <Divider />
    <Year>2012</Year>
    <ul>
      <Step title="I joined a local startup 🧑🏽‍💻" stack={['PHP', 'CodeIgniter']}>
        I joined  a local startup as software developer and core team member.
      </Step>
      <Step title="Max arrived 👶🏽">
    ...
    <ul>
      <Step title="1st Freelance web page." stack={['HTML', 'CSS']}>
        I team up with a cousin to develop our 1st webpage. Local mezquite charcoal company.
      </Step>
      <Step title="1st Freelance web app." stack={['PHP', 'CodeIgniter']}>
        I team up with a cousin to develop our 1st webapp for a local startup.
      </Step>
    </ul>
    <Divider />
    <Year>2010</Year>
    <ul>
      <Step title="1st National Basketball Tournament.">
        I played my 1st national tournament with my university team (ITH Venados). 5th postion of 12.
      </Step>
      <Step title="Landed my 1st software developer position." stack={['PHP']}>
        Local company focused on real estate appraisals hired me to maintain and develop his internal tools. Php and MySql.
      </Step>
      <Step title="Dropout university.">
        I fell in love with programming and at that point, I've already passed all the programming-related subjects and I decided to drop out and focus %100 on my software development job.
      </Step>
    </ul>
    <Divider />
    <Year>2009</Year>
    <ul>
      <Step title="First IT job 🔥">
        I worked for a local company, I was the printer & network and support guy.
      </Step>
    ...
    <ul>
      ...
      <Step title="Winamp Shoutcast radio streaming server.">
        I configured and launched my own internet radio project, with Winamp Shoutcast Server it was alive for 5 months.
      </Step>
    </ul>
    <Divider />
    <Year>2005</Year>
    <ul>
      <Step title="Started university at Instituto Tecnologico de Hermosillo.">
        Started studying BA in Information Technology.
      </Step>
      <Step title="University Basketball A Team 🏀 ⛹🏽‍♂️">
        I trained during the summer as soon as the scholar year started they invite me to the A team.
      </Step>
    </ul>
    <Divider />
    <Year>2003</Year>
    ...
    <>
      ...
      <ul>
        <Step title="Re-joined ArkusNexus 🧑🏽‍💻" stack={['React', 'NestJS', 'JS', 'TS']}>
          I returned to ArkusNexus to work as tech lead and help the organization in more operational activities.
        </Step>
      </ul>
      <Divider />
      <Year>2021</Year>
      <ul>
        <Step title="Joined Encora 🧑🏽‍💻" stack={['React', 'JS', 'TS']}>
          I joined Encora as software developer, I worked for OpenTable as contractor frontend developer.
        </Step>
      </ul>
      <Divider />
      <Year>2020</Year>
      <ul>
        <Step title="Joined Enrutate 🧑🏽‍💻 🚌" stack={['React', 'JS', 'RoR']}>
          I joined Enrutate as contractor frontend developer, 10 hours per week.
        </Step>
      </ul>
      <Divider />
      <Year>2019</Year>
      <ul>
        <Step title="Became a Tech Lead 👨🏻‍💻" stack={['Android', 'Java']}>
          Starting at the beginning of 2019, I moved into a tech leadership role
          on an health app development team at ArkusNexus.
        </Step>
      ...
      <ul>
        <Step title="Joined at ArkusNexus 🧑🏽‍💻" stack={['RoR', 'React', 'Android', 'Java']}>
          I joined ArkusNexus as senior software developer.
        </Step>
        <Step title="Moved to Tijuana, Mex.">
          I moved to Tijuana for 2nd time to work at ArkusNexus on-site.
        </Step>
      ...
      <ul>
        <Step title="Joined at Leap Global Innovation Labs 🧑🏽‍💻" stack={['RoR', 'React', 'JS', 'WordPress']}>
          A friend invited me to a recently created development company from San Francisco, associate engineer.
        </Step>
      </ul>
